    ...
    <script type="text/javascript">
        ...
        function pageInit() {
            jQuery("#pagelist").jqGrid({
                url: "${ctxPath}/system/log/findLoginLogJson.htm",
                mtype: "POST",
                styleUI: 'Bootstrap',
                viewrecords: true,
                ...
                colNames: ["loginlogid", "用户名",  "IP","MAC","登录时间"],
                colModel: [
                    {name: "loginlogid", hidden: true, key: true},
                    {name: "username", width: 100, sortable: false},
                    {name: "ip", width: 100, sortable: false, editable: false},
                    {name: "mac", width: 150, sortable: false, editable: false},
