...
public class ExcelHelper {
	...
	public static void main(String[] args) {
		...
		// InputStream is2;
		// try {
		// is2 = new FileInputStream("e:\\hehe.xls");
		// ExcelReader excelReader = new ExcelReader();
		// String[][] temp = excelReader.readExcelContent(is2);
		...
		tempMap.put("ww", "111");
		tempMap.put("yy", 2233334);
		temp.add(tempMap);
		excelHelper.writeExcel("haha", new String[] {}, new String[] { "ww", "yy" }, temp, null);
	}
}
